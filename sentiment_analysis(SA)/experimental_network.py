...
#note that before you change the structure of the model, you have to delete the pre-trained saved_model.pt file, and train the exp model,
#else errors can accure, that the saved_exp model does not fit in your changed one
